...
class VideoAnnotatorUI:
    ...
    def _build_controls(self, parent):
        ...
        ttk.Entry(ctrl, textvariable=self.coord_x, width=7).grid(row=1, column=lp['param_start_col']+9, pady=(5,0))
        ttk.Label(ctrl, text="Y:").grid(row=1, column=lp['param_start_col']+10, pady=(5,0))
        ttk.Entry(ctrl, textvariable=self.coord_y, width=7).grid(row=1, column=lp['param_start_col']+11, pady=(5,0))
